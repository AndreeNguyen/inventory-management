 ...
 * @author doqua
 */
public class tongquanuser extends javax.swing.JFrame {
...
private void LoadData() {
 ...
 private void init() {
Chart.addLegend("Hàng nhập", Color.yellow, Color.yellow);
Chart.addLegend("Hàng xuất", Color.blue, Color.blue);
Chart.addData(new ModelChart("01/10", new double[]{5500,200}));
Chart.addData(new ModelChart("05/10", new double[]{200,500}));
Chart.addData(new ModelChart("10/10", new double[]{198,200}));
Chart.start();
    ...
    private void initComponents() {
        ...
        pnlChart1Layout.setHorizontalGroup(
            ...
            .addGroup(pnlChart1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(Chart1, javax.swing.GroupLayout.DEFAULT_SIZE, 276, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        pnlSucchuakhoLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlSucchuakhoLayout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tongquanuser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new tongquanuser().setVisible(true);
            }
        });
    }
